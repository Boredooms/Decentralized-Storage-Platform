...
function readIndividualTransforms(el) {
  ...
  if (map) {
    ...
    if (sc && sc.length) {
      const sx = ((_b = sc[0]) == null ? void 0 : _b.value) ?? 1;
      const sy = ((_c = sc[1]) == null ? void 0 : _c.value) ?? sx;
      out.scale = `${sx} ${sy}`;
    }
    const tr = map.get("translate");
    if (tr && tr.length) {
      const tx = ((_d = tr[0]) == null ? void 0 : _d.value) ?? 0;
      const ty = ((_e = tr[1]) == null ? void 0 : _e.value) ?? 0;
      const ux = ((_f = tr[0]) == null ? void 0 : _f.unit) ?? "px";
      const uy = ((_g = tr[1]) == null ? void 0 : _g.unit) ?? "px";
